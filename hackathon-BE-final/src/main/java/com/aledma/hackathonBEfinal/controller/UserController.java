...
public class UserController {
    ...
    public ResponseEntity<List<WebScrapingDto>> getUserQuestions(@PathVariable Long userId) {
        try{
            List<WebScrapingDto> list = userService.getUserWebScrapingDtoList(userId);
